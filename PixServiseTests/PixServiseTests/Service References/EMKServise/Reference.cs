...
namespace PixServiseTests.EMKServise {
    ...
    public partial class AppointedMedication : PixServiseTests.EMKServise.MedRecord {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private byte MedicineIssueTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public byte MedicineIssueType {
            get {
                return this.MedicineIssueTypeField;
            }
            set {
                if ((this.MedicineIssueTypeField.Equals(value) != true)) {
    ...
    public interface IEmkService {
        ...
        void AddMedRecord(string guid, string idLpu, string idPatientMis, string idCaseMis, string idStepMis, PixServiseTests.EMKServise.MedRecord medRecord);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmkService/AddMedRecord", ReplyAction="http://tempuri.org/IEmkService/AddMedRecordResponse")]
        System.Threading.Tasks.Task AddMedRecordAsync(string guid, string idLpu, string idPatientMis, string idCaseMis, string idStepMis, PixServiseTests.EMKServise.MedRecord medRecord);
    ...
    public partial class EmkServiceClient : System.ServiceModel.ClientBase<PixServiseTests.EMKServise.IEmkService>, PixServiseTests.EMKServise.IEmkService {
        ...
        public void AddMedRecord(string guid, string idLpu, string idPatientMis, string idCaseMis, string idStepMis, PixServiseTests.EMKServise.MedRecord medRecord) {
            base.Channel.AddMedRecord(guid, idLpu, idPatientMis, idCaseMis, idStepMis, medRecord);
        }
        
        public System.Threading.Tasks.Task AddMedRecordAsync(string guid, string idLpu, string idPatientMis, string idCaseMis, string idStepMis, PixServiseTests.EMKServise.MedRecord medRecord) {
            return base.Channel.AddMedRecordAsync(guid, idLpu, idPatientMis, idCaseMis, idStepMis, medRecord);
        }
