    ...
    public class AddCaseTest : Data
    {
        ...
        public void _HashTest()
        {
            using (TestPixServiceClient c = new TestPixServiceClient())
            {
                ...
                c.AddPatient(Data.globalGuid, Data.idlpu, p);
            }
            using (TestEmkServiceClient c = new TestEmkServiceClient())
            {
                ...
                c.UpdateCase(Data.globalGuid, p);
            }
            if (Global.errors == "")
        ...
        //        PixClient.AddPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.186", patient);
        //    }
        //    using (TestEmkServiceClient EmkClient = new TestEmkServiceClient())
        //    {
