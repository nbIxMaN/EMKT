...
namespace PixServiseTests
{
    ...
    public class PatientTests : Data
    {
        ...
        public void UpdatePatient()
        {
            ...
            client.AddPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", patient);
            client.UpdatePatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", patient);
            ...
            client.UpdatePatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", patient2);
            if (Global.errors == "")
                Assert.Pass();
            else
        ...
        public void FindByFamily()
        {
            ...
            client.AddPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", patient);
            var patents = client.GetPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", forSearch, SourceType.Fed);
            if (Global.errors == "")
                Assert.Pass();
            else
                Assert.Fail(Global.errors);
        ...
        public void SearchPatientByMinParametrAndDocument()
        {
            ...
            client.GetPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", forSearch, SourceType.Reg);
            if (Global.errors == "")
                Assert.Pass();
            else
                Assert.Fail(Global.errors);
        ...
        public void FindPatientByIdMIS()
        {
            ...
            client.GetPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.118", find, SourceType.Reg);
            if (Global.errors == "")
                Assert.Pass();
            else
                Assert.Fail(Global.errors);
        ...
        public void FindMultidocumentPatient()
        {
            ...
            patient.Sex = 1;
            client.AddPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.230", patient);
            client.UpdatePatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.230", patient);
            PatientDto patient2 = new PatientDto();
            ...
            client.GetPatient(Data.globalGuid, "1.2.643.5.1.13.3.25.78.230", patient2, SourceType.Reg);
        }
    }
}
