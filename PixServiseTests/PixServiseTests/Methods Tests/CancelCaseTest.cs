    ...
    class CancelCaseTest : Data
    {
        ...
        public void CancelMinAmbCase()
        {
            ...
            using (TestEmkServiceClient EmkClient = new TestEmkServiceClient())
            {
                ...
                EmkClient.CancelCase(Data.globalGuid, Data.idlpu, caseAmb.IdPatientMis, caseAmb.IdCaseMis);
            }
            if (Global.errors == "")
                Assert.Pass();
            else
        ...
        public void CancelMinStatCase()
        {
            ...
            using (TestEmkServiceClient EmkClient = new TestEmkServiceClient())
            {
                ...
                EmkClient.CancelCase(Data.globalGuid, Data.idlpu, caseStat.IdPatientMis, caseStat.IdCaseMis);
            }
            if (Global.errors == "")
                Assert.Pass();
            else
